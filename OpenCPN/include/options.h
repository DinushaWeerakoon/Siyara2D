...
// Should we show tooltips?
    ...
    size_t                  m_pageDisplay, m_pageConnections, m_pageCharts, m_pageShips, m_pageUI, m_pagePlugins, m_pageFilter;//--Added m_pageFilter by Chamal Perera
    int                     lastPage;
...
//    For General Options
    ...
    wxTextCtrl *MainQueryBox;
    
    wxChoice   *NameDataset;  //-single selection
    wxChoice   *CallDataset;
    wxChoice   *MMSIDataset;
    wxChoice   *IMODataset;
    
    wxChoice   *TypeDataset;  //-group selection
    wxChoice   *NavStatusDataset;
...
//    For "PlugIns" Panel
    ...
    //-AIS Filter page of options------
    /*
     Created by Chamal Perera
     */
    wxScrolledWindow *AISFilterPanel;
